...
namespace newCubeBackend.ArticleController
{
    ...
    public class ArticleController : ControllerBase
    {
        ...
        public JsonResult Post(Article article)
        {
            ...
            string query = @"INSERT INTO tableArticle(nomArticle, anneeArticle, prixUnitaireArticle, prixCartonArticle, prixFournisseurArticle, referenceArticle, tvaArticle, domaineArticle, descriptionArticle, familleArticle, coutStockageArticle, IdFournisseurCE) 
                            VALUES (@Nom_Article, @Annee_Article, @Prix_Unitaire_Article, @Prix_Carton_Article, @Prix_Fournisseur_Article, @Reference_Article, @TVA_Article, @Domaine_Article, @Description_Article, @Famille_Article, @Cout_Stockage_Article, @Id_Fournisseur_CE)";
            ...
            cmd.Parameters.AddWithValue("@Id_Fournisseur_CE", article.Id_Fournisseur_CE);
        ...
        public JsonResult Put(int id, Article article)
        {
            var sql = @"UPDATE tableArticle
                        ...
                        IdFournisseurCE = @Id_Fournisseur_CE
                        WHERE IdArticle = @Id";
